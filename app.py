...
embedding_model = GoogleGenerativeAIEmbeddings(google_api_key="C:/Users/kalya/Desktop/internship_sessions/RAG/Keys/.openai_key.txt",model="models/embedding-001")
st.snow()                                                          
